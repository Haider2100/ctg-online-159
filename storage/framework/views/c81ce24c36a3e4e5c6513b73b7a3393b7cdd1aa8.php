...
<main class="app-content">
    ...
    <div class="row user">
        <div class="col-md-12">
            <div class="profile">
                <div class="info"><img class="user-img" src="<?php echo e(asset('assets\images\pp1.png')); ?>">
                ...
                <div class="tab-pane active" id="user-timeline">
                    <div class="timeline-post">
                        <div class="post-media"><a href="#"><img src="https://s3.amazonaws.com/uifaces/faces/twitter/jsa/48.jpg"></a>
                            <div class="content">
                                <h5><a href="<?php echo e($todo->id); ?>"><?php echo e($todo->task); ?></a></h5>
                                <p class="text-muted"><small><?php echo e($todo->created_at.'\\Post By-'.$todo->user_id); ?></small></p>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\CTG-ONLINE-159\LaravelProject\ctg-online-159\resources\views/profile.blade.php ENDPATH**/ ?>